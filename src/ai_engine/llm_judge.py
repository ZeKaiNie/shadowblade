...
def judge_skill_ssd(
    ...
    intent_result = _run_ssd_subtask(SSD_INTENT_PROMPT, api_base, model, **common_args)
    permission_result = _run_ssd_subtask(SSD_PERMISSION_PROMPT, api_base, model, **common_args)
    covert_result = _run_ssd_subtask(SSD_COVERT_PROMPT, api_base, model, **common_args)
    crossfile_result = _run_ssd_subtask(SSD_CROSSFILE_PROMPT, api_base, model, **common_args)
